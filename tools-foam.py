"""Generate the surf-foam band overlay for anthonyameendyer.org.

An abstract shore break: a horizontal band of dense foam that thins to
nothing above and below. The tile repeats horizontally only (seamless in x,
